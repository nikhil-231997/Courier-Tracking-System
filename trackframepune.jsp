...
<%@ page import="java.sql.*" %>
 <%
	...
	try
  {
	 ...
	 String sql1;
	 sql1="Select * from pune where tracking_no="+trackingno;
	...
	while(rs.next())
	{
	 ...
	 if(validp==true)
		{
			out.println("Your courier has been dispatched from Pune");
		}
		else
		{
			out.println("Your courier is not yet dispatched from Pune");
		
		}
	 %>
	 <jsp:forward page="trackframenagpur.jsp"/>
  	<%
	stmt.close();
	conn.close();
  }
